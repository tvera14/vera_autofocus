...
# This version is modified to work with black and white microscope images that are not shrunk as much and
# also not converted to faux RGB by tripling the array.
